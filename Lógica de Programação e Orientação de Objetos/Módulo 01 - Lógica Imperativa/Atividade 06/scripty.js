...
do {
  ...
  if (turma == 'A') {
    ...
    console.log(
      "O numero de alunos aprovados na turma 'A' foi de: " +
        aprovadosA +
        ' Aluno(s)'
    )
    console.log(
      "A maior nota da turma 'A' foi de: " +
        melhorAlunoA +
        ' com a nota ' +
        maiorNotaA
    )
    ...
    console.log(
      "O numero de alunos aprovados na turma 'B' foi de: " +
        aprovadosB +
        ' Aluno(s)'
    )
    console.log(
      "A maior nota da turma 'B' foi de: " +
        melhorAlunoB +
        ' com a nota ' +
        maiorNotaB
    )
    ...
    console.log(
      "O numero de alunos aprovados na turma 'C' foi de: " +
        aprovadosC +
        ' Aluno(s)'
    )
    console.log(
      "A maior nota da turma 'C' foi de: " +
        melhorAlunoC +
        ' com a nota ' +
        maiorNotaC
    )
    ...
    console.log(
      "O numero de alunos aprovados na turma 'D' foi de: " +
        aprovadosD +
        ' Aluno(s)'
    )
    console.log(
      "A maior nota da turma 'D' foi de: " +
        melhorAlunoD +
        ' com a nota ' +
        maiorNotaD
    )
...
console.log(
  'O número total de alunos aprovados é: ' +
...
console.log(
  "Turma 'A':\n " +
    ...
    ' Alunos aprovados.\n ' +
    maiorNotaA +
    ' foi a maior nota, pertecente ao aluno(a): ' +
    melhorAlunoA
)
console.log(
  "Turma 'B':\n " +
